...
I2CEEPROM_Example_Wire.ino - This is a DEMO example showing the usage of the
library for I2C EEPROM (standard Arduino I2C interface SDA/SCL on all but DUE
...
# URL       : https://github.com/chartup/chartup-I2CEEPROM-Library/blob/master/examples/I2CEEPROM_Example_Wire/I2CEEPROM_Example_Wire.ino
...
void setup() {
	Serial.begin(19200);
	chartup_I2CEEPROM i2ceeprom(0, 7);
